...
samplesheet <- read_tsv("sample_sheet.tsv")
```
...
sample.path <- "SRR9264343/outs/filtered_feature_bc_matrix/"
...
list_of_files <- str_c("CellRanger_Outputs/CaronBourque2020/", 
                       samples, 
...
annotations <- genes(ens.hs.107, return.type = "data.frame")  %>%
