...
* How to use `chilam01_101` reservation for executing jobs?
  ...
  * Steps ...
    ...
    2. Then start slurm  interactive login : `sintr -c 8 --mem=4G -t 01:00:00 --reservation=chilam01_101 `
      * Where ...
        * sintr: slurm command for interactive job
        * -c: number of threads
        * --mem: memory
...
$ sintr -c 7 --mem=8G -t 01:00:00 --reservation=chilam01_101
