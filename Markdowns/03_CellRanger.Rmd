...
Alternatively we have downloded cell ranger for you and placed in Software folder.

The cellrange execulable is in Software/cellranger-7.2.0/bin and to run cellranger do the following.
