...
sce <- readRDS("Data/Caron_normalized.500.rds")
sce
```
...
shuffled data.
Code for PCA permutation test: https://twitter.com/MattOldach/status/1075037756563382274
...
saveRDS(sce, "Data/caron_dimRed.Rds")
```
